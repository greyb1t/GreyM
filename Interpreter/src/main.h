...
enum class VmOpcodes : uint32_t {
  ...
  MOV_REGISTER_MEMORY_REG_OFFSET =
      0x4278BEA1,  // mov ecx, dword ptr [eax + 0x84]
  MOV_MEMORY_REG_OFFSET_REG = 0x1927BA1F,  // mov [reg + 0x0], reg
  MOV_MEMORY_REG_OFFSET_IMM = 0x0F0B255A,  // mov [reg + 0x0], imm
...
enum VmOpcodes1 : uint32_t {
  bMOV_REGISTER_IMMEDIATE = 0x8BB147AA,
  bMOV_REGISTER_REGISTER = 0xB9C115AB,
  bMOV_REGISTER_MEMORY_IMMEDIATE = 0x19BFE12B,
  bMOV_REGISTER_MEMORY_REG_OFFSET = 0x4278BEA1,
  bSUB_REGISTER_IMMEDIATE = 0xFE126DF1,
  bSUB_REGISTER_MEMORY_REG_OFFSET = 0x200B01B0,
  bCALL_IMMEDIATE = 0x437BDFA1,
  bCALL_MEMORY = 0xB2988BE1,
  bPUSH_IMM = 0x31CBE5B1,
